...
def Topology(args):
    ...
    info('*** stations/\n')
    mov= net.addStation ('mov', ip='192.168.20.11/24', mac ='00:00:00:00:00:06', defaultRoute='via 192.168.20.254', position='60,60,0', **kwargs)
    ...
    ap3 = net.addAccessPoint('ap3', ssid='ssid-ap3', mac ='00:00:00:00:00:09', mode='g', channel='6',
                                 failMode="secure", position='63,60,0',  range= 20)
    ...
    ap3.cmd('route add -net 192.168.20.0/24 gw 192.168.20.254')
    mov.cmd('route add -net 192.168.20.0/24 gw 192.168.20.254')
    mov.cmd('route add -net 192.168.1.0/24 gw 192.168.1.254')
    mov.cmd('route add -net 192.168.2.0/24 gw 192.168.2.254')
    mov.cmd('route add -net 192.168.4.0/24 gw 192.168.20.254')
